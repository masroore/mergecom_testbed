...
#============================================================================
#    LICENSE                            The Merge DICOM Toolkit license number that
...
#    MPEG2_MPML_FRAG_SYNTAX
#    MPEG2_MPML_SYNTAX
#    MPEG2_MPHL_FRAG_SYNTAX
#    MPEG2_MPHL_SYNTAX
#    MPEG4_AVC_H264_HP_LEVEL_4_1_FRAG_SYNTAX
#    MPEG4_AVC_H264_HP_LEVEL_4_1_SYNTAX
#    MPEG4_AVC_H264_BDC_HP_LEVEL_4_1_FRAG_SYNTAX
#    MPEG4_AVC_H264_BDC_HP_LEVEL_4_1_SYNTAX
#    MPEG4_AVC_H264_HP_LEVEL_4_2_2D_FRAG_SYNTAX
#    MPEG4_AVC_H264_HP_LEVEL_4_2_2D_SYNTAX
#    MPEG4_AVC_H264_HP_LEVEL_4_2_3D_FRAG_SYNTAX
#    MPEG4_AVC_H264_HP_LEVEL_4_2_3D_SYNTAX
#    MPEG4_AVC_H264_STEREO_HP_LEVEL_4_2_FRAG_SYNTAX
...
IMPLEMENTATION_VERSION               = MergeCOM3_5_16_0
...
MPEG2_MPML_FRAG_SYNTAX                  = 1.2.840.10008.1.2.4.100.1
MPEG2_MPML_SYNTAX                       = 1.2.840.10008.1.2.4.100
MPEG2_MPHL_FRAG_SYNTAX                  = 1.2.840.10008.1.2.4.101.1
MPEG2_MPHL_SYNTAX                       = 1.2.840.10008.1.2.4.101
MPEG4_AVC_H264_HP_LEVEL_4_1_FRAG_SYNTAX        = 1.2.840.10008.1.2.4.102.1
MPEG4_AVC_H264_HP_LEVEL_4_1_SYNTAX             = 1.2.840.10008.1.2.4.102
MPEG4_AVC_H264_BDC_HP_LEVEL_4_1_FRAG_SYNTAX    = 1.2.840.10008.1.2.4.103.1
MPEG4_AVC_H264_BDC_HP_LEVEL_4_1_SYNTAX         = 1.2.840.10008.1.2.4.103
MPEG4_AVC_H264_HP_LEVEL_4_2_2D_FRAG_SYNTAX     = 1.2.840.10008.1.2.4.104.1
MPEG4_AVC_H264_HP_LEVEL_4_2_2D_SYNTAX          = 1.2.840.10008.1.2.4.104
MPEG4_AVC_H264_HP_LEVEL_4_2_3D_FRAG_SYNTAX     = 1.2.840.10008.1.2.4.105.1
MPEG4_AVC_H264_HP_LEVEL_4_2_3D_SYNTAX          = 1.2.840.10008.1.2.4.105
MPEG4_AVC_H264_STEREO_HP_LEVEL_4_2_FRAG_SYNTAX = 1.2.840.10008.1.2.4.106.1
...
ENCAPSULATED_UNCOMPRESSED_ELE_SYNTAX    = 1.2.840.10008.1.2.1.98
#
...
[DUL_PARMS]
#
ARTIM_TIMEOUT             = 30  # The number of seconds to use as a timeout waiting for association
# request or waiting for the peer to shut down an association.
ASSOC_REPLY_TIMEOUT       = 15  # The number of seconds to wait for reply to associate request.
RELEASE_TIMEOUT           = 15  # The number of seconds to wait for reply to associate release.
WRITE_TIMEOUT             = 15  # The number of seconds to wait for a network write to be accepted.
CONNECT_TIMEOUT           = 15  # The number of seconds to wait for a network connect to be accepted.
...
#                                            are to be preserved.
#    ALLOW_INVALID_LENGTH_FOR_VR            When set to 'No', attribute data values
#                                            with incorrect length according to
#                                            DICOM, i.e. more than the maximum
#                                            allowed length or not a multiple of
#                                            the unit size for fixed length VRs
#                                            (SS, US, AT, SL, UL, SV, UV, FL, FD)
#                                            will cause an MC_INVALID_LENGTH_FOR_VR
#                                            error on DICOM data reading.
...
#   PIXEL_BUFFER_SIZE                       This setting configures the maximum size of chunks
#                                            (100 * PIXEL_BUFFER_SIZE) in which pixel data is stored internally
#                                            in the toolkit memory (by default 100 * 128 * 1024 for
#                                            WIN and LINUX platforms or 100 * 64 * 1024 otherwise).
#                                           NOTE:  This setting also defines the size of special
#                                            internal buffer and should be used with care.
#
#
[MESSAGE_PARMS]
#
...
DICTIONARY_FILE                         = E:\Virtual Machines\shared\mrg\merge_test\merge_test\bin\Debug\config\mrgcom3.dct
MSG_INFO_FILE                           = E:\Virtual Machines\shared\mrg\merge_test\merge_test\bin\Debug\config\mrgcom3.msg
TEMP_FILE_DIRECTORY                     = .
PEGASUS_OPCODE_PATH                     = .
#
...
UNKNOWN_VR_CODE                         = UN
ALLOW_INVALID_LENGTH_FOR_VR             = Yes
...
# List tag values or ranges to be filtered during read
# Example: 00080002,  00080003-00080010, G0003
DECODER_TAG_FILTER                      =
#
#============================================================================
...
#                                           referenced.
#   ENABLE_ICU4C_LIBRARY                    When set to yes, Merge DICOM Toolkit uses
#                                           ICU4C library for Unicode conversion.
#
[MEDIA_PARMS]
#
...
[TRANSPORT_PARMS]
#
TCPIP_LISTEN_PORT           = 11112 # Port 11112 is the default DICOM non-privileged port.
IP_TYPE                     = IPV4
